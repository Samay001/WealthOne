  ...
  return (
    <div className="h-screen flex flex-col relative overflow-hidden bg-[#050314]">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('https://framerusercontent.com/images/oFP0q4fZtDXdgTseJflmzPeHDW4.webp')",
      ...
      <header className="relative z-10 w-full h-[50vh] flex flex-col justify-between py-6 px-4 md:px-8 lg:px-16 mt-10">
        <div className="max-w-7xl mx-auto w-full flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-gray-300 text-sm mt-1">Manage your funds in single space</p>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-6 md:gap-10">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-white">San Francisco, US</span>
            </div>
        ...
        {/* Footer moved inside header to be part of the 50% */}
        <footer className="w-full">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center">
            <div className="text-white text-sm mb-4 md:mb-0">
              © 2024 Copyright - WealthOne | All rights reserved.
            </div>
