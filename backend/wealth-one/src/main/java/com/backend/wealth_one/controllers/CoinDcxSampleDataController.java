...
@RestController
@RequestMapping("/coin-dcx")
public class CoinDcxSampleDataController {

    private static final Logger logger = LoggerFactory.getLogger(CoinDcxSampleDataController.class);
    private static final String SAMPLE_DATA_PATH = "src/main/resources/data/coindcx/sample.json";

    private final ObjectMapper objectMapper;

    public CoinDcxSampleDataController(ObjectMapper objectMapper) {
